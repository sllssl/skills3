  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="display-5 fw-bold text-primary">Teams</h2>
      ...
      <div className="card shadow-sm mb-4">
        <div className="card-body">
          <h5 className="card-title">Teams Overview</h5>
          <p className="card-text">This section displays all teams from the Octofit backend API.</p>
        </div>
      </div>
        ...
        <div className="card-body">
          <div className="table-responsive">
            <table className="table table-hover table-bordered align-middle">
              ...
              <tbody>
                {data.length === 0 ? (
                  <tr><td colSpan={headers.length} className="text-center">No teams found.</td></tr>
                ) : (
                  data.map((item, idx) => (
                    <tr key={item.id || idx}>
